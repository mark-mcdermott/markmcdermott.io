---
title: "Barebones Rails, Nuxt and Fly.io Tutorial"
spoiler: With RSpec, Vitest and Playwright Tests
date: 1/29/25
href: bareones-rails-rspec-nuxt-vitest-playwright-flyio-tutorial
---

Here's a tutorial I've been working on for awhile. It's just a hello world app for how to wire together a Rails API backend with a Nuxt frontend and deploy it to Fly.io. It also includes RSpec unit tests, Vitest component tests and Playwright end-to-end tests.
