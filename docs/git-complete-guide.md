...
## Overview
Git workflow for the c64 portfolio project, designed for both learning and development.
...
#### `learn/[topic]`
**Examples**: `learn/astro-routing`, `learn/scss-architecture`, `learn/css-grid`
- Active learning work
- 1-2 weeks typically
- Merge to main after completion

#### `experiment/[topic]`
**Examples**: `experiment/crt-effect`, `experiment/container-queries`
- Safe exploration of ideas
- Expected to potentially fail
- Cherry-pick successes to learning branches

#### `feat/[name]` / `fix/[issue]`
- New features or bug fixes for the portfolio site
...
git commit -m ":memo: Update curriculum with completed flexbox lesson"
```
...
git commit -m ":books: Understand CSS specificity calculation and cascade rules"
