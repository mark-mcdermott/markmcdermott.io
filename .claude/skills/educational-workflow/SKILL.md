...
Structured patterns for educational sessions on the c64 portfolio site.
...
1. **Explain** - Teach the concept with context from the portfolio site's actual code
...
## MANDATORY Testing
Run tests after:
- Any Astro component changes
- Any SCSS/CSS changes that affect layout
- Any content collection schema changes
- Any page or routing changes
- Before any commit
