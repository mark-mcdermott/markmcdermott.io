...
| App Test | `/app-test` | Workflow | Testing the site for errors (Playwright) |
...
**Examples**: `/lesson-start`, `/lesson-start astro-fundamentals`, `/lesson-start scss-architecture`
**Does**: Loads learning progress, identifies next lesson, sets up context

### /app-test
**Purpose**: Test the portfolio site for errors using Playwright
**Usage**: `/app-test`
**Does**: Builds the site, runs E2E tests, checks for build errors and broken pages
