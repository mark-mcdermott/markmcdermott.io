...
|------------|--------------|-----|
| `astro-expert.md` | Astro components, content collections, routing, islands, deployment | Read file |
| `css-expert.md` | CSS3/SCSS patterns, layout, responsive design, animations, C64 aesthetic | Read file |
...
Need implementation advice for Astro?
  -> CONSULT astro-expert.md (load inline, don't delegate)

Need implementation advice for CSS/SCSS?
  -> CONSULT css-expert.md (load inline, don't delegate)
